angular.module('app', ['ngNewRouter', 'ngSanitize', 'ngTouch', 'pascalprecht.translate', 'ui.bootstrap', 'app.home', 'app.about', 'app.projects', 'app.contact', 'app.imprint', 'app.privacy', 'app.secret'])
