...
const socials = [
  ...
  // },
  {
    id: 2,
    icon: <FaGithub />,
    link: "https://github.com/sebastianhof",
  },
  {
    id: 3,
    icon: <FaLinkedinIn />,
    link: "https://www.linkedin.com/in/sebastianhof",
  },
  // {
  //   id: 4,
  //   icon: <FaInstagram />,
  ...
  return (
    <aside className="sticky top-0 bg-white md:mx-8 lg:mx-4 mb-8 p-6 shadow-md rounded-md -mt-40">
      ...
      <div className="text-center">
        <h1 className="text-xl text-gray-800 font-bold mb-1">Sebastian Hof</h1>
        <p className="text-sm text-gray-400 mb-3">
          Application Development Manager at
          <a href="https://www.accenture.com/" target="_blank" rel="noreferrer" className="text-purple-600 pl-1">
            Accenture
          </a>
        </p>
        <a
